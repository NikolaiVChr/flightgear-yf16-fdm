...
# Design error: Sometimes a station can hold SubModelStation or Pylon. GUI payload dialog options handled from pylon wont solve that.
# Solution: Just make submodels into weapon that the pylon can also hold.
...
# empty sets should always be named 'Empty'
